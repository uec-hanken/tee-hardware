...
NUMA_PREFIX = $(if $(filter $(NUMACTL),0),,$(shell $(teehw_dir)/hardware/chipyard/scripts/numa_prefix))
...
include $(teehw_dir)/hardware/chipyard/tools/torture.mk
...
SOURCE_DIRS = $(addprefix $(teehw_dir)/,hardware/teehw/ hardware/chipyard/generators hardware/chipyard/sims/firesim/sim hardware/chipyard/tools/barstools hardware/chipyard/fpga/fpga-shells hardware/chipyard/fpga/src)
SCALA_SOURCES = $(call lookup_srcs,$(SOURCE_DIRS),scala)
VLOG_SOURCES = $(call lookup_srcs,$(SOURCE_DIRS),sv) $(call lookup_srcs,$(SOURCE_DIRS),v)
# This assumes no SBT meta-build sources
SBT_SOURCE_DIRS = $(addprefix $(teehw_dir)/,hardware/teehw/ hardware/chipyard/generators hardware/chipyard/sims/firesim/sim hardware/chipyard/tools)
...
#########################################################################################
# Create the resources with the makefiles included for tee-hardware
#########################################################################################
...
firrtl_temp: $(FIRRTL_FILE) $(ANNO_FILE) $(VLOG_SOURCES)
	$(call run_scala_main,$(SBT_PROJECT),barstools.tapeout.transforms.GenerateTopAndHarness,\
