...
set_property PACKAGE_PIN {N28} [get_ports {qspi_0_qspi_cs}]
set_property PACKAGE_PIN {M30} [get_ports {qspi_0_qspi_sck}]
set_property PACKAGE_PIN {N30} [get_ports {qspi_0_qspi_miso}]
set_property PACKAGE_PIN {P30} [get_ports {qspi_0_qspi_mosi}]
set_property PACKAGE_PIN {AT15} [get_ports {qspi_0_qspi_wp}]
set_property PACKAGE_PIN {AT16} [get_ports {qspi_0_qspi_hold}]
set_property IOSTANDARD {LVCMOS12} [get_ports {qspi_0_qspi_cs}]
set_property IOSTANDARD {LVCMOS12} [get_ports {qspi_0_qspi_sck}]
set_property IOSTANDARD {LVCMOS12} [get_ports {qspi_0_qspi_miso}]
set_property IOSTANDARD {LVCMOS12} [get_ports {qspi_0_qspi_mosi}]
