...
set_property BOARD_PIN {clk_p} [get_ports {c0_sys_clk_p}]
set_property BOARD_PIN {clk_n} [get_ports {c0_sys_clk_n}]
create_clock -name sys_diff_clk -period 5.0 [get_ports c0_sys_clk_p]
set_input_jitter [get_clocks -of_objects [get_ports c0_sys_clk_p]] 0.5
