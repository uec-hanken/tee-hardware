...
trait WithFPGAVC707PureConnect {
  ...
  chip.qspi.foreach { case qspi =>
    ...
    ConnectFMCXilinxGPIO(1, 9, qspi.qspi_mosi, true, MISCPORT)
...
trait WithFPGAVC707ToChipConnect extends WithFPGAVC707InternNoChipCreate with WithFPGAVC707InternConnect {
  ...
  intern.memser.foreach { memser =>
    ...
    ConnectFMCXilinxGPIO(2, 7, memser.out.bits(7), true, FMCDAO)
    ConnectFMCXilinxGPIO(2, 9, memser.out.bits(6), true, FMCDAO)
    ConnectFMCXilinxGPIO(2, 13, memser.out.bits(5), true, FMCDAO)
    ConnectFMCXilinxGPIO(2, 15, memser.out.bits(4), true, FMCDAO)
    ConnectFMCXilinxGPIO(2, 17, memser.out.bits(3), true, FMCDAO)
    ConnectFMCXilinxGPIO(2, 19, memser.out.bits(2), true, FMCDAO)
    ConnectFMCXilinxGPIO(2, 21, memser.out.bits(1), true, FMCDAO)
    ConnectFMCXilinxGPIO(2, 23, memser.out.bits(0), true, FMCDAO)
  ...
  intern.extser.foreach{ extser =>
    ...
    ConnectFMCXilinxGPIO(1, 19, extser.out.bits(7), true, FMCDAO)
    ConnectFMCXilinxGPIO(1, 21, extser.out.bits(6), true, FMCDAO)
    ConnectFMCXilinxGPIO(1, 25, extser.out.bits(5), true, FMCDAO)
    ConnectFMCXilinxGPIO(1, 27, extser.out.bits(4), true, FMCDAO)
    ConnectFMCXilinxGPIO(1, 31, extser.out.bits(3), true, FMCDAO)
    ConnectFMCXilinxGPIO(1, 33, extser.out.bits(2), true, FMCDAO)
    ConnectFMCXilinxGPIO(1, 35, extser.out.bits(1), true, FMCDAO)
    ConnectFMCXilinxGPIO(1, 37, extser.out.bits(0), true, FMCDAO)
...
trait WithFPGAVC707FromChipConnect extends WithFPGAVC707PureConnect {
  ...
  chip.tlport.foreach{ case tlport =>
    ...
    require(tlport.d.bits.opcode.getWidth == 3, s"${tlport.d.bits.opcode.getWidth}")
    ConnectFMCXilinxGPIO(JP20, 22, tlport.d.bits.opcode(2),  true, FMC)
    ConnectFMCXilinxGPIO(JP20, 23, tlport.d.bits.opcode(1),  true, FMC)
    ConnectFMCXilinxGPIO(JP20, 24, tlport.d.bits.opcode(0),  true, FMC)
    require(tlport.d.bits.param.getWidth == 2, s"${tlport.d.bits.param.getWidth}")
    ConnectFMCXilinxGPIO(JP20, 25, tlport.d.bits.param(1),  true, FMC)
    ConnectFMCXilinxGPIO(JP20, 26, tlport.d.bits.param(0),  true, FMC)
    require(tlport.d.bits.size.getWidth == 3, s"${tlport.d.bits.size.getWidth}")
    ConnectFMCXilinxGPIO(JP20, 27, tlport.d.bits.size(2),  true, FMC)
    ConnectFMCXilinxGPIO(JP20, 28, tlport.d.bits.size(1),  true, FMC)
    ConnectFMCXilinxGPIO(JP20, 31, tlport.d.bits.size(0),  true, FMC)
    require(tlport.d.bits.source.getWidth == 6, s"${tlport.d.bits.source.getWidth}")
    ConnectFMCXilinxGPIO(JP20, 32, tlport.d.bits.source(5),  true, FMC)
    ConnectFMCXilinxGPIO(JP20, 33, tlport.d.bits.source(4),  true, FMC)
    ConnectFMCXilinxGPIO(JP20, 34, tlport.d.bits.source(3),  true, FMC)
    ConnectFMCXilinxGPIO(JP20, 35, tlport.d.bits.source(2),  true, FMC)
    ConnectFMCXilinxGPIO(JP20, 36, tlport.d.bits.source(1),  true, FMC)
    ConnectFMCXilinxGPIO(JP20, 37, tlport.d.bits.source(0),  true, FMC)
    require(tlport.d.bits.sink.getWidth == 1, s"${tlport.d.bits.sink.getWidth}")
    ConnectFMCXilinxGPIO(JP20, 38, tlport.d.bits.sink(0),  true, FMC)
    ConnectFMCXilinxGPIO(JP20, 39, tlport.d.bits.denied,  true, FMC)
    ConnectFMCXilinxGPIO(JP20, 40, tlport.d.bits.corrupt,  true, FMC)
    require(tlport.d.bits.data.getWidth == 32, s"${tlport.d.bits.data.getWidth}")
    ConnectFMCXilinxGPIO(JP21, 5, tlport.d.bits.data(31),  true, FMC)
    ConnectFMCXilinxGPIO(JP21, 6, tlport.d.bits.data(30),  true, FMC)
    ConnectFMCXilinxGPIO(JP21, 7, tlport.d.bits.data(29),  true, FMC)
    ConnectFMCXilinxGPIO(JP21, 8, tlport.d.bits.data(28),  true, FMC)
    ConnectFMCXilinxGPIO(JP21, 9, tlport.d.bits.data(27),  true, FMC)
    ConnectFMCXilinxGPIO(JP21, 10, tlport.d.bits.data(26),  true, FMC)
    ConnectFMCXilinxGPIO(JP21, 13, tlport.d.bits.data(25),  true, FMC)
    ConnectFMCXilinxGPIO(JP21, 14, tlport.d.bits.data(24),  true, FMC)
    ConnectFMCXilinxGPIO(JP21, 15, tlport.d.bits.data(23),  true, FMC)
    ConnectFMCXilinxGPIO(JP21, 16, tlport.d.bits.data(22),  true, FMC)
    ConnectFMCXilinxGPIO(JP21, 17, tlport.d.bits.data(21),  true, FMC)
    ConnectFMCXilinxGPIO(JP21, 18, tlport.d.bits.data(20),  true, FMC)
    ConnectFMCXilinxGPIO(JP21, 19, tlport.d.bits.data(19),  true, FMC)
    ConnectFMCXilinxGPIO(JP21, 20, tlport.d.bits.data(18),  true, FMC)
    ConnectFMCXilinxGPIO(JP21, 21, tlport.d.bits.data(17),  true, FMC)
    ConnectFMCXilinxGPIO(JP21, 22, tlport.d.bits.data(16),  true, FMC)
    ConnectFMCXilinxGPIO(JP21, 23, tlport.d.bits.data(15),  true, FMC)
    ConnectFMCXilinxGPIO(JP21, 24, tlport.d.bits.data(14),  true, FMC)
    ConnectFMCXilinxGPIO(JP21, 25, tlport.d.bits.data(13),  true, FMC)
    ConnectFMCXilinxGPIO(JP21, 26, tlport.d.bits.data(12),  true, FMC)
    ConnectFMCXilinxGPIO(JP21, 27, tlport.d.bits.data(11),  true, FMC)
    ConnectFMCXilinxGPIO(JP21, 28, tlport.d.bits.data(10),  true, FMC)
    ConnectFMCXilinxGPIO(JP21, 31, tlport.d.bits.data( 9),  true, FMC)
    ConnectFMCXilinxGPIO(JP21, 32, tlport.d.bits.data( 8),  true, FMC)
    ConnectFMCXilinxGPIO(JP21, 33, tlport.d.bits.data( 7),  true, FMC)
    ConnectFMCXilinxGPIO(JP21, 34, tlport.d.bits.data( 6),  true, FMC)
    ConnectFMCXilinxGPIO(JP21, 35, tlport.d.bits.data( 5),  true, FMC)
    ConnectFMCXilinxGPIO(JP21, 36, tlport.d.bits.data( 4),  true, FMC)
    ConnectFMCXilinxGPIO(JP21, 37, tlport.d.bits.data( 3),  true, FMC)
    ConnectFMCXilinxGPIO(JP21, 38, tlport.d.bits.data( 2),  true, FMC)
    ConnectFMCXilinxGPIO(JP21, 39, tlport.d.bits.data( 1),  true, FMC)
    ConnectFMCXilinxGPIO(JP21, 40, tlport.d.bits.data( 0),  true, FMC)
  }
  ...
  chip.memser.foreach { memser =>
    ConnectFMCXilinxGPIO(0, 31, memser.in.bits(7),  true, FMCDAO)
    ConnectFMCXilinxGPIO(0, 33, memser.in.bits(6),  true, FMCDAO)
    ConnectFMCXilinxGPIO(0, 35, memser.in.bits(5),  true, FMCDAO)
    ConnectFMCXilinxGPIO(0, 37, memser.in.bits(4),  true, FMCDAO)
    ConnectFMCXilinxGPIO(0, 39, memser.in.bits(3),  true, FMCDAO)
    ConnectFMCXilinxGPIO(1, 1, memser.in.bits(2),  true, FMCDAO)
    ConnectFMCXilinxGPIO(1, 5, memser.in.bits(1),  true, FMCDAO)
    ConnectFMCXilinxGPIO(1, 7, memser.in.bits(0),  true, FMCDAO)
  ...
  chip.extser.foreach{ extser =>
    ConnectFMCXilinxGPIO(0, 5, extser.in.bits(7),  true, FMCDAO)
    ConnectFMCXilinxGPIO(0, 7, extser.in.bits(6),  true, FMCDAO)
    ConnectFMCXilinxGPIO(0, 9, extser.in.bits(5),  true, FMCDAO)
    ConnectFMCXilinxGPIO(0, 13, extser.in.bits(4),  true, FMCDAO)
    ConnectFMCXilinxGPIO(0, 15, extser.in.bits(3),  true, FMCDAO)
    ConnectFMCXilinxGPIO(0, 17, extser.in.bits(2),  true, FMCDAO)
    ConnectFMCXilinxGPIO(0, 19, extser.in.bits(1),  true, FMCDAO)
    ConnectFMCXilinxGPIO(0, 21, extser.in.bits(0),  true, FMCDAO)
