...
object ConnectFMCGPIO {
  def npmap(FMC: FMCTR5): Map[(Int, Int), Analog] = {
    ...
    val ext = if(FMC.ext) Map (
      ...
      (3, 0) -> FMC.HB_RX_CLK_p.get,
      (3, 1) -> FMC.HB_RX_CLK_n.get,
      (3, 2) -> FMC.HB_TX_CLK_p.get,
      (3, 3) -> FMC.HB_TX_CLK_n.get,
      (3, 4) -> FMC.HB_RX_p.get(0),
      (3, 5) -> FMC.HB_RX_n.get(0),
      (3, 6) -> FMC.HB_RX_p.get(1),
      (3, 7) -> FMC.HB_RX_n.get(1),
      (3, 8) -> FMC.HB_RX_p.get(2),
      (3, 9) -> FMC.HB_RX_n.get(2),
      (3, 10) -> FMC.HB_RX_p.get(3),
      (3, 11) -> FMC.HB_RX_n.get(3),
      (3, 12) -> FMC.HB_RX_p.get(4),
      (3, 13) -> FMC.HB_RX_n.get(4),
      (3, 14) -> FMC.HB_RX_p.get(5),
      (3, 15) -> FMC.HB_RX_n.get(5),
      (3, 16) -> FMC.HB_RX_p.get(6),
      (3, 17) -> FMC.HB_RX_n.get(6),
      (3, 18) -> FMC.HB_RX_p.get(7),
      (3, 19) -> FMC.HB_RX_n.get(7),
      (3, 20) -> FMC.HB_TX_p.get(0),
      (3, 21) -> FMC.HB_TX_n.get(0),
      (3, 22) -> FMC.HB_TX_p.get(1),
      (3, 23) -> FMC.HB_TX_n.get(1),
      (3, 24) -> FMC.HB_TX_p.get(2),
      (3, 25) -> FMC.HB_TX_n.get(2),
      (3, 26) -> FMC.HB_TX_p.get(3),
      (3, 27) -> FMC.HB_TX_n.get(3),
      (3, 28) -> FMC.HB_TX_p.get(4),
      (3, 29) -> FMC.HB_TX_n.get(4),
      (3, 30) -> FMC.HB_TX_p.get(5),
      (3, 31) -> FMC.HB_TX_n.get(5),
      (3, 32) -> FMC.HB_TX_p.get(6),
      (3, 33) -> FMC.HB_TX_n.get(6),
      (3, 34) -> FMC.HB_TX_p.get(7),
      (3, 35) -> FMC.HB_TX_n.get(7),
    ) else Map()
    default ++ ext
  }
