...
object GenerateSimFiles extends App with HasGenerateSimConfig {
  ...
  def writeBootrom(): Unit = {
    ...
    writeResource("/testchipip/bootrom/bootrom.rv64.img", "./notsupposedtoappear/")
    writeResource("/testchipip/bootrom/bootrom.rv32.img", "./notsupposedtoappear/")
    writeResource("/bootrom/bootrom.img", "./notsupposedtoappear/")
  }
