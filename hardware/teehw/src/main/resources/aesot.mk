...
AESOT_PREPROC_SVERILOG = aesot.preprocessed.sv
AESOT_PREPROC_VERILOG = aesot.preprocessed.v

.PHONY: aesot $(AESOT_PREPROC_SVERILOG) $(AESOT_PREPROC_VERILOG)
...
$(AESOT_PREPROC_SVERILOG): $(AESOT_ALL_VSRCS)
	mkdir -p $(dir $(AESOT_PREPROC_SVERILOG))
