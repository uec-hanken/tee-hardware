...
// README (CKDUR)
// This is a very silly implementation of the same MIG but using an AXI32 instead
// of a AXI64 interface. Yes! I know, I also wonder why this is not supported.

//scalastyle:off
//turn off linter: blackbox name must match verilog module
class vc707mig32(depth : BigInt)(implicit val p:Parameters) extends BlackBox
{
